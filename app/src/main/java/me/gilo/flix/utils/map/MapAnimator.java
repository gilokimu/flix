package me.gilo.flix.utils.map;
...
public class MapAnimator {
    ...
    static final int GREY = Color.parseColor("#868688");
    ...
    public void animateRoute(GoogleMap googleMap, List<LatLng> bangaloreRoute) {
        ...
        PolylineOptions optionsBackground = new PolylineOptions().add(bangaloreRoute.get(0)).color(GREY).width(16);
        backgroundPolyline = googleMap.addPolyline(optionsBackground);

        optionsForeground = new PolylineOptions().add(bangaloreRoute.get(0)).color(Color.BLACK).width(16);
